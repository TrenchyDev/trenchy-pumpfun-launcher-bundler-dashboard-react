...
export default function Launch() {
  ...
  const fillTestLaunch = () => {
    updateForm({
      ...
      description: 'test launch for\nhttps://github.com/TrenchyDev/trenchy-pump-launcher-bundler',
      website: 'https://github.com/TrenchyDev/trenchy-pump-launcher-bundler',
      twitter: 'https://github.com/TrenchyDev/trenchy-pump-launcher-bundler',
      telegram: 'https://github.com/TrenchyDev/trenchy-pump-launcher-bundler',
      devBuyAmount: 0.1,
      bundleWalletCount: 2,
